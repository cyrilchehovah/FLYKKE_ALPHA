class UsersController < ApplicationController
  ...
  def new_preview
    ...
    @post = Post.new(title: @page.best_title, interest: @interest, description: @page.description, graphic_content: @page.images.best, video: @object.videos.first.embed_code.html_safe, url: @page.url, site_name: @page.meta['og:site_name'])
